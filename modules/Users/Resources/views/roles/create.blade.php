<x-admin::layouts.master>
    <div class="max-w-6xl mx-auto space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                ...
                <nav class="flex items-center gap-2 text-xs font-medium text-gray-500 mb-2">
                    ...
                    <span class="iconify text-xs text-gray-400" data-icon="heroicons:chevron-right"></span>
                    <span class="text-gray-800 font-semibold">Create Role</span>
                </nav>
                <h1 class="text-2xl font-bold text-gray-900">Create New Role</h1>
                <p class="text-sm text-gray-500 mt-0.5">Define a new system role and assign initial permissions.</p>
            </div>
        ...
        <form action="{{ route('users.roles.store') }}" method="POST" class="space-y-6">
            @csrf
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="name" name="name" placeholder="e.g. Content Writer" 
                                   class="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:bg-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all text-sm" required>
                        </div>
                        <div>
                            ...
                            <p class="text-[11px] text-gray-400 mt-1">Guard defines the authentication area (default: 'web').</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                        ...
                        <div class="border border-gray-200 rounded-xl overflow-hidden">
                            ...
                            <div class="p-4 flex flex-col gap-3">
                                <label class="flex items-start gap-3 cursor-pointer group">
                                    <input type="checkbox" name="permissions[]" value="view_users" class="perm-checkbox mt-0.5 rounded border-gray-300 text-primary focus:ring-primary w-4 h-4">
                                    <div>
                                ...
                                <label class="flex items-start gap-3 cursor-pointer group">
                                    <input type="checkbox" name="permissions[]" value="edit_users" class="perm-checkbox mt-0.5 rounded border-gray-300 text-primary focus:ring-primary w-4 h-4">
                                    <div>
                        ...
                        <div class="border border-gray-200 rounded-xl overflow-hidden">
                            ...
                            <div class="p-4 flex flex-col gap-3">
                                <label class="flex items-start gap-3 cursor-pointer group">
                                    <input type="checkbox" name="permissions[]" value="view_settings" class="perm-checkbox mt-0.5 rounded border-gray-300 text-primary focus:ring-primary w-4 h-4">
                                    <div>

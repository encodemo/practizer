        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-sm font-medium text-gray-900 dark:text-gray-200">Create New Group</span>
                </div>
                <h1 class="mt-2 text-2xl font-bold text-gray-900 dark:text-white">Create User Group</h1>
            </div>
        </div>
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="name" id="name" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="e.g. Editor, Manager, Customer Support" required>
                            </div>

                            <!-- Description -->
                            <div>
                                <label for="description" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Description</label>
                                <textarea id="description" name="description" rows="3" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="Briefly describe the purpose of this group and its access level..."></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="w-full lg:w-80 space-y-6">
                    <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div class="p-6">
                            <div x-data="{ isActived: true }" class="flex items-center justify-between">
